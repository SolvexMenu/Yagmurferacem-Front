...
export default function SignUpForm({
	...
	const form = useForm({
		...
		validators: {
			onSubmit: z.object({
				name: z.string().min(2, "İsim minimum 2 karakter olmalı"),
				email: z.email("Geçersiz eposta adresi"),
	...
	return (
		<div className="mx-auto w-full mt-10 max-w-md p-6">
			...
			>
				...
				<div>
					<form.Field name="email">
						{(field) => (
							<div className="space-y-2">
								<Label htmlFor={field.name}>Eposta</Label>
								<Input
									id={field.name}
									name={field.name}
									type="email"
			...
			<div className="mt-4 text-center">
				...
				>
					Zaten bir hesabınız varmı? Giriş yap
				</Button>
			</div>
		</div>
	);
